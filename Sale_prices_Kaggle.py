...
katataksh_Correlation = correlation['CORR'].sort_values(ascending=False)  #sort values by ascending order of corelation
print("Katataksh A",katataksh_Correlation)




###### explore the varaince of features
# ################# katataksh B
katataksh_B=[]
...
principal_analysis =pd.DataFrame(data=principal_analysis , columns=['P1','P2','P3','P4','P5','P6','P7','P8','P9','P10','P11','P12','P13','P14','P15','P16','P17','P18','P19','P20']) #create df :
...
pca_data = principal_analysis    #copy katataksh_e -> pca_data
